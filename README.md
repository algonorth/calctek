...
## Modified Files
	...
	Catch-all route serving app.blade.php


	### package.json

	Added vue + @vitejs/plugin-vue
	...
	Added Preline variants, Inter font, dark color scheme, Vue SFC source scanning


	### resources/js/app.js
	
	Vue 3 entry point instead of blank


	### resources/js/bootstrap.js
	
	Added CSRF token wiring to axios
